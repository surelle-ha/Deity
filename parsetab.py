...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','deity.py',58),
  ('statement -> expression','statement',1,'p_statement_expr','deity.py',62),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','deity.py',66),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','deity.py',67),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','deity.py',68),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','deity.py',69),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','deity.py',76),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','deity.py',80),
  ('expression -> NUMBER','expression',1,'p_expression_number','deity.py',84),
  ('expression -> NAME','expression',1,'p_expression_name','deity.py',88),
]
